// Mon Sep 11 10:19:04 CDT 2017
// 
// TextIO from Eck; minor modification by Kauffman to remove
// extraneous ? from output when reading from standard input
    ...
    private static void skipWhitespace() {
        ...
        while (ch != EOF && Character.isWhitespace(ch)) {
            ...
            if (ch == '\n' && readingStandardInput && writingStandardOutput) {
                // out.print("? "); // CK: Why would you do this???
                out.flush();
            }
            ch = lookChar();
        }
